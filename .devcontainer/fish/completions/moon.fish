...
complete -c moon -n "__fish_moon_using_subcommand test" -l doc-index -d 'Run only the index-th doc test in the file. Only valid when `--file` is also specified' -r
...
complete -c moon -n "__fish_moon_using_subcommand coverage; and not __fish_seen_subcommand_from analyze report clean help" -l build-graph -d 'Generate build graph'
...
complete -c moon -n "__fish_moon_using_subcommand coverage; and __fish_seen_subcommand_from analyze" -l build-graph -d 'Generate build graph'
